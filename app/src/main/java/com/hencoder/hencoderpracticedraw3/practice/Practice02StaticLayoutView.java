...
public class Practice02StaticLayoutView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        text = "dasdasfvbkbxz dasdasf, asdsad, asdsad,  adsdsad, dasdas,qweqwe, asdasdd,sadasd.";
        StaticLayout staticLayout1 = new StaticLayout(text, textPaint, 600, Layout.Alignment.ALIGN_NORMAL,
                1, 0, true);
